...
```properties
zebra.grpc.registryAddress=http://172.24.140.248:2379,http://172.24.140.251:2379,http://172.24.140.252:2379
zebra.grpc.port=50003
opentracing.upd.addr=172.24.150.132:9411/api/v2/spans
zebra.database.url[0]=jdbc:sqlserver://172.24.180.138:1433;database=cpxdb0
zebra.database.username[0]=sa
zebra.database.pwd[0]=jty5585354?
zebra.database.dataSourceName[0]=ds0
zebra.database.url[1]=jdbc:sqlserver://172.24.180.138:1433;database=cpxdb1
zebra.database.username[1]=sa
zebra.database.pwd[1]=jty5585354?
