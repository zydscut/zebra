...
public class MonitorService implements ApplicationListener<WebServerInitializedEvent> {
	...
	private MonitorNotifyListener.NotifyServiceListener listener = (RpcServiceBaseInfo rpcSeriviceBaseInfo,
		...
		// CAUTION: DELETE Event doesn't return ip and port!!
		// notify:PUT##RpcSeriviceBaseInfo [group=default,
		// service=com.guosen.examples.service.HelloService,
		// type=server, target=null, set=0, version=1.0.0, ip=172.24.20.225,
		// port=50003, nodeId=79e31b2f-964f-4cb9-90ae-1eca0799a183]
		// notify:DELETE##RpcSeriviceBaseInfo [group=default,
		// service=com.guosen.examples.service.HelloService,
		// type=server, target=null, set=0, version=1.0.0, ip=null, port=0,
		// nodeId=79e31b2f-964f-4cb9-90ae-1eca0799a183]
	...
	private void init() {
		...
		// kvs {
		// key:
		// "/zebra/default/com.guosen.examples.service.HelloService/1.0.0/0/server/f99a40ae-81e2-4904-9c46-d44b2339b979"
		// create_revision: 674
		// mod_revision: 674
		// version: 1
		// value: "172.24.140.240:50003"
		// lease: 7591767510251756096
		// }
	...
	private void processNodeMetrics(String nodeId, String ip, int port, HealthResponse resp) {
		...
		try (BufferedReader br = new BufferedReader(new StringReader(metricStr))) {
			while ((line = br.readLine()) != null) {
				// grpc_server_handling_ms_count{grpc_type="UNARY",grpc_service="com.guosen.examples.service.HelloService",grpc_method="sayHello",instance="172.25.172.18",}
				// 26.0
				// grpc_server_handling_ms_sum{grpc_type="UNARY",grpc_service="com.guosen.examples.service.HelloService",grpc_method="sayHello",instance="172.25.172.18",}
				// 158.0
				// grpc_server_started_total{grpc_type="UNARY",grpc_service="com.guosen.examples.service.HelloService",grpc_method="sayHello",instance="172.25.175.72",}
				// 7.0
